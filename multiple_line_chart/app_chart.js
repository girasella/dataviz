...
var xAxis = d3.svg.axis().tickFormat(d3.format("0"))
    .scale(xScale)
    .orient("bottom"),

    xAxis2 = d3.svg.axis().tickFormat(d3.format("0")) // xAxis for brush slider
    .scale(xScale2)
    .orient("bottom");    
...
d3.csv("../data/delittiPS2.csv", function(error, data) { 
